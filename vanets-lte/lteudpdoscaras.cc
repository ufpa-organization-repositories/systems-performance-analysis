...
main (int argc, char *argv[])
{
  ...
  std::string numrun = ss2.str();


     std::string STATS = Scheduler + "-" + numnode + "v"+ numrun +"-STATS.txt";
     std::ofstream logger (STATS.c_str());

   std::string PDlT = Scheduler+"-"+ numnode +"v"+ numrun +"-DlTHROUGHPUT.txt";
   std::string PUlT = Scheduler+"-"+numnode+ "v"+ numrun +"-UlTHROUGHPUT.txt";
   std::string PDlD = Scheduler+"-"+numnode+ "v"+ numrun +"-DlDELAY.txt";
   std::string PUlD = Scheduler+"-"+numnode+ "v"+ numrun +"-UlDELAY.txt";
   std::string PDlJ = Scheduler+"-"+numnode+ "v"+ numrun +"-DlJITTER.txt";
   std::string PUlJ = Scheduler+"-"+numnode+ "v"+ numrun +"-UlJITTER.txt";
